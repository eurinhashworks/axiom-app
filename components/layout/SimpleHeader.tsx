...
const SimpleHeader: React.FC = () => {
    ...
    return (
        <header className="py-3 sm:py-4 px-4 sm:px-8 border-b border-border/40 mb-4 sm:mb-8 flex-shrink-0 glass sticky top-0 z-40 transition-all animate-slide-down">
