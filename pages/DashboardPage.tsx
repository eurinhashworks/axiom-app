...
const DashboardPage: React.FC = () => {
    ...
    const filteredAndSortedIdeas = useMemo(() => {
        ...
        return sorted;
    }, [ideas, searchQuery, filterStatus, sortBy]);
    ...
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="space-y-4">
                <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <select
                        ...
                        className="px-4 py-2 rounded-md border border-border bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-brand focus:border-transparent"
                    >
                ...
                {(searchQuery || filterStatus !== 'all') && (
                    <div className="text-sm text-muted-foreground">
                        {filteredAndSortedIdeas.length} idée(s) trouvée(s)
            ...
            {filteredAndSortedIdeas.length > 0 ? (
                ...
                <EmptyState
                    title={searchQuery || filterStatus !== 'all' ? "Aucune idée correspondante" : "Aucune idée pour le moment"}
                    description={
                        searchQuery || filterStatus !== 'all'
