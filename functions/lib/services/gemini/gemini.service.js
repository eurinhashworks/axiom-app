...
exports.escapePromptInput = escapePromptInput;
exports.generateContentWithSchema = generateContentWithSchema;
exports.analyzeBrainDump = analyzeBrainDump;
exports.evaluateIdea = evaluateIdea;
exports.generateRoadmap = generateRoadmap;
exports.prioritizeIdeas = prioritizeIdeas;
 ...
 */
function validateStringArray(arr, fieldName, minLength = 1) {
...
async function generateContentWithSchema(options) {
    var _a;
    ...
    try {
        ...
        const jsonText = (_a = response.text) === null || _a === void 0 ? void 0 : _a.trim();
        if (!jsonText) {
...
async function analyzeBrainDump(brainDump) {
...
Fournissez votre analyse au format JSON spécifié.`;
    ...
    for (const q of result.clarifyingQuestions) {
        if (typeof q === 'string')
            continue; // Support ancien format
...
async function evaluateIdea(idea) {
    ...
    const questionsForPrompt = idea.analysis.clarifyingQuestions.map((q) => {
        if (typeof q === 'string')
            return q;
        return q.question;
    });
...
${Array.isArray(idea.analysis.clarifyingQuestions) && idea.analysis.clarifyingQuestions[0] && typeof idea.analysis.clarifyingQuestions[0] === 'object'
        ? idea.analysis.clarifyingQuestions.map((q, i) => { var _a, _b; return `- ${i + 1}. ${q.question} (Réponse choisie: ${((_b = (_a = idea.clarifyingAnswers) === null || _a === void 0 ? void 0 : _a.find((a) => a.questionIndex === i)) === null || _b === void 0 ? void 0 : _b.selectedOption) || 'Non répondue'})`; }).join('\n')
...
async function generateRoadmap(idea) {
    ...
    if (!((_a = idea.analysis) === null || _a === void 0 ? void 0 : _a.summary)) {
...
async function prioritizeIdeas(ideas) {
    var _a;
    // Validation de l'entrée
    ...
    const evaluatedIdeas = ideas.filter(idea => {
        var _a;
        return ((_a = idea.analysis) === null || _a === void 0 ? void 0 : _a.summary) &&
    ...
    const ideaSummaries = evaluatedIdeas.map(idea => {
        ...
        const escapedSummary = escapePromptInput(((_a = idea.analysis) === null || _a === void 0 ? void 0 : _a.summary) || '');
        const opportunityScore = typeof idea.opportunityScore === 'number' ? idea.opportunityScore.toFixed(1) : 'N/A';
        const feasibilityScore = typeof idea.feasibilityScore === 'number' ? idea.feasibilityScore.toFixed(1) : 'N/A';
        const problemUrgency = (_c = (_b = idea.evaluation) === null || _b === void 0 ? void 0 : _b.problemUrgency) !== null && _c !== void 0 ? _c : 'N/A';
        const targetMarketSize = (_e = (_d = idea.evaluation) === null || _d === void 0 ? void 0 : _d.targetMarketSize) !== null && _e !== void 0 ? _e : 'N/A';
        const competitiveAdvantage = (_g = (_f = idea.evaluation) === null || _f === void 0 ? void 0 : _f.competitiveAdvantage) !== null && _g !== void 0 ? _g : 'N/A';
        const personalAlignment = (_j = (_h = idea.evaluation) === null || _h === void 0 ? void 0 : _h.personalAlignment) !== null && _j !== void 0 ? _j : 'N/A';
        const technicalFeasibility = (_l = (_k = idea.evaluation) === null || _k === void 0 ? void 0 : _k.technicalFeasibility) !== null && _l !== void 0 ? _l : 'N/A';
        return `
---
### ${escapedTitle}
...
Fournissez votre analyse de priorisation.`;
    try {
        ...
        return ((_a = response.text) === null || _a === void 0 ? void 0 : _a.trim()) || "Aucune réponse générée";
    }
    catch (error) {
