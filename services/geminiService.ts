...
${Array.isArray(idea.analysis.clarifyingQuestions) && idea.analysis.clarifyingQuestions[0] && typeof idea.analysis.clarifyingQuestions[0] === 'object' 
    ? idea.analysis.clarifyingQuestions.map((q: any, i: number) => `- ${i + 1}. ${q.question} (Réponse choisie: ${idea.clarifyingAnswers?.find(a => a.questionIndex === i)?.selectedOption || 'Non répondue'})`).join('\n')
